...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        fig = px.pie(
            ...
            values='class', 
            names='Launch Site', 
            title='Success Repartition across all sites'
        ) 
    else:
        ...
        fig = px.pie(
            ...
            # values='class', 
            names='class', 
            title=f'Success vs Failure on Launch for site {entered_site}'
        )
...
def get_scatter_chart(entered_site, payload_range):
    ...
    fig = px.scatter(
        ...
        color_discrete_sequence=px.colors.qualitative.Set1,  # Use ColorBrewer Set1 palette
        title=f'Success vs Payload Mass for site {entered_site}'
    )
